<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditTeachers.aspx.cs" Inherits="CompSciIA.EditTeachers" %>
...
<body>
    ...
    <div class="auto-style2">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" Height="242px" Width="689px">
                <Columns>
  ...
  <a href="https://localhost:44343/TeacherForm.aspx"> Manage Teachers</a>
              <a href="https://localhost:44343/EditTeachers.aspx" class="active"> Edit Teachers</a>
