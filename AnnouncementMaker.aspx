<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnnouncementMaker.aspx.cs" Inherits="CompSciIA.AnnouncementMaker" %>
...
.vertical-menu a.active {
    ...
    <div class="header">
          <asp:Textbox runat="server" ID="txtUserName1" Height="46px" Width="968px" />
            ...
            <div class="auto-style2">
                ...
                <asp:TextBox ID="Announcementtxt" runat="server" Height="234px" Width="593px"></asp:TextBox>
  ...
  <a href="https://localhost:44343/AnnouncementMaker.aspx" class="active"> Make Announcement</a>
